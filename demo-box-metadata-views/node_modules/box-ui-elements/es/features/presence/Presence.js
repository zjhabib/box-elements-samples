...
function (_Component) {
  ...
  _createClass(Presence, [{
    ...
    value: function render() {
      ...
      }, React.createElement(FormattedMessage, messages.previewPresenceFlyoutActivityCTA))) : React.createElement(PresenceDropdown, {
      ...
      }), collaborators.length > maxDisplayedAvatars && // eslint-disable-next-line jsx-a11y/no-noninteractive-tabindex
      React.createElement("div", _extends({
        className: presenceCountClassName,
        tabIndex: "0"
      }, avatarAttributes), collaborators.length - maxDisplayedAvatars > maxAdditionalCollaboratorsNum ? "".concat(maxAdditionalCollaboratorsNum, "+") : "+".concat(collaborators.length - maxDisplayedAvatars))), React.createElement(Overlay, {
