...
function SharingModal(_ref) {
  ...
  var _React$useState5 = React.useState(null),
      ...
      currentUserID = _React$useState6[0],
      setCurrentUserID = _React$useState6[1];

  var _React$useState7 = React.useState(null),
      _React$useState8 = _slicedToArray(_React$useState7, 2),
      componentErrorMessage = _React$useState8[0],
      setComponentErrorMessage = _React$useState8[1];

  var _React$useState9 = React.useState(null),
      _React$useState10 = _slicedToArray(_React$useState9, 2),
      collaboratorsList = _React$useState10[0],
      setCollaboratorsList = _React$useState10[1];

  var _React$useState11 = React.useState(null),
      _React$useState12 = _slicedToArray(_React$useState11, 2),
      onAddLink = _React$useState12[0],
      setOnAddLink = _React$useState12[1];

  var _React$useState13 = React.useState(null),
      _React$useState14 = _slicedToArray(_React$useState13, 2),
      onRemoveLink = _React$useState14[0],
      setOnRemoveLink = _React$useState14[1];

  var _React$useState15 = React.useState(null),
      _React$useState16 = _slicedToArray(_React$useState15, 2),
      changeSharedLinkAccessLevel = _React$useState16[0],
      setChangeSharedLinkAccessLevel = _React$useState16[1];

  var _React$useState17 = React.useState(null),
      _React$useState18 = _slicedToArray(_React$useState17, 2),
      changeSharedLinkPermissionLevel = _React$useState18[0],
      setChangeSharedLinkPermissionLevel = _React$useState18[1];

  var _React$useState19 = React.useState(null),
      _React$useState20 = _slicedToArray(_React$useState19, 2),
      onSubmitSettings = _React$useState20[0],
      setOnSubmitSettings = _React$useState20[1];

  var _React$useState21 = React.useState(CONTENT_SHARING_VIEWS.UNIFIED_SHARE_MODAL),
      _React$useState22 = _slicedToArray(_React$useState21, 2),
      currentView = _React$useState22[0],
      setCurrentView = _React$useState22[1];

  var _React$useState23 = React.useState(null),
      _React$useState24 = _slicedToArray(_React$useState23, 2),
      getContacts = _React$useState24[0],
      setGetContacts = _React$useState24[1];

  var _React$useState25 = React.useState(null),
      _React$useState26 = _slicedToArray(_React$useState25, 2),
      sendInvites = _React$useState26[0],
      setSendInvites = _React$useState26[1];

  var _React$useState27 = React.useState(true),
      _React$useState28 = _slicedToArray(_React$useState27, 2),
      isLoading = _React$useState28[0],
      setIsLoading = _React$useState28[1];

  var _React$useState29 = React.useState(true),
      _React$useState30 = _slicedToArray(_React$useState29, 2),
      isOpen = _React$useState30[0],
      setIsOpen = _React$useState30[1]; // Handle successful GET requests to /files or /folders
  ...
  }, [setComponentErrorMessage]); // Reset state if the API has changed
  ...
  }, [api, getError, handleGetItemSuccess, item, itemID, itemType, sharedLink]); // Get initial data for the user
  ...
  if (componentErrorMessage) {
    return React.createElement(ErrorMask, {
      errorHeader: React.createElement(FormattedMessage, componentErrorMessage)
    });
  ...
  return React.createElement(Internationalize, {
    ...
    className: "be"
  }, React.createElement(SharingNotification, {
  ...
  }), isOpen && currentView === CONTENT_SHARING_VIEWS.SHARED_LINK_SETTINGS && React.createElement(SharedLinkSettingsModal, _extends({
  ...
  }, sharedLink)), isOpen && currentView === CONTENT_SHARING_VIEWS.UNIFIED_SHARE_MODAL && React.createElement(UnifiedShareModal, {
