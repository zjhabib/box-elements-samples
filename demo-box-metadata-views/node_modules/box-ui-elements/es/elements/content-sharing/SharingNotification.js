...
import { convertCollabsRequest, convertCollabsResponse, convertGroupContactsResponse, convertItemResponse, convertSharedLinkPermissions, convertSharedLinkSettings, convertUserContactsResponse, USM_TO_API_ACCESS_LEVEL_MAP } from '../../features/unified-share-modal/utils/convertData';
...
function SharingNotification(_ref) {
  ...
  var handleUpdateSharedLinkError = function handleUpdateSharedLinkError() {
  ...
  var _useSharedLink = useSharedLink(api, itemID, itemType, permissions, accessLevel, {
    ...
    transformSettings: function transformSettings(settings, access) {
      return convertSharedLinkSettings(settings, access, serverURL);
    }
  }),
